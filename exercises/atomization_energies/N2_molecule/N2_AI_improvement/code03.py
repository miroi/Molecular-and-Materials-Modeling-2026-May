# By Miroslav, extended ASE-EMT workflow for N2
...
distances = np.linspace(0.8, 2.0, 25)  # Å
energies = []
...
plt.plot(distances, energies, 'o-', label='ASE-EMT')
...
plt.legend()
plt.tight_layout()
plt.savefig("N2_potential_curve.png", dpi=150)
plt.show()
